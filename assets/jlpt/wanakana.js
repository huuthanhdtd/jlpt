!function(t, e) {
    ...
    var r = n(function(t) {
      ...
      , S = function(t, e) {
        if (!f(t))
            return t;
        var n, r;
        if (e && "function" == typeof (n = t.toString) && !f(r = n.call(t)))
            return r;
        if ("function" == typeof (n = t.valueOf) && !f(r = n.call(t)))
            return r;
        if (!e && "function" == typeof (n = t.toString) && !f(r = n.call(t)))
            return r;
    ...
    : function(t, e, n) {
      ...
      , Q = n(function(t) {
        ...
        (t.exports = function(t, n, o, i) {
            ...
            u && (q(o, "name") || Y(o, "name", n)),
            t[n] !== o && (u && (q(o, e) || Y(o, e, t[n] ? "" + t[n] : r.join(n + ""))),
            t === g ? t[n] = o : i ? t[n] ? t[n] = o : Y(t, n, o) : (delete t[n],
            Y(t, n, o)))
        }
      ...
      , ut = ot && rt || ot
      , at = function(t, e, n) {
        var r, o, i, u, a = t & at.F, c = t & at.G, f = t & at.P, s = t & at.B, l = c ? g : t & at.S ? g[e] || (g[e] = {}) : (g[e] || {}).prototype, h = c ? $ : $[e] || ($[e] = {}), d = h.prototype || (h.prototype = {});
        for (r in c && (n = e),
        n)
            i = ((o = !a && l && void 0 !== l[r]) ? l : n)[r],
            u = s && o ? ut(i, g) : f && "function" == typeof i ? ut(Function.call, i) : i,
            l && it(l, r, i, t & at.U),
            h[r] != i && Y(h, r, u),
            f && d[r] != i && (d[r] = i)
    };
    ...
    for (var ct, ft = at, st = Object.freeze({
        default: ft,
        __moduleExports: ft
    }), lt = X("typed_array"), ht = X("view"), dt = !(!g.ArrayBuffer || !g.DataView), vt = dt, pt = 0, yt = "Int8Array,Uint8Array,Uint8ClampedArray,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array".split(","); 9 > pt; )
        (ct = g[yt[pt++]]) ? (Y(ct.prototype, lt, !0),
        Y(ct.prototype, ht, !0)) : vt = !1;
    var gt = {
        ABV: dt,
        CONSTR: vt,
        TYPED: lt,
      ...
      , Zt = function(t) {
        return function(e, n, r) {
            var o, i = $t(e), u = kt(i.length), a = Qt(r, u);
            if (t && n != n) {
                for (; u > a; )
                    if ((o = i[a++]) != o)
                        return !0
      ...
      , we = je && Oe || je
      , xe = function(t) {
        for (var e = we(this), n = kt(e.length), r = arguments.length, o = Qt(r > 1 ? arguments[1] : void 0, n), i = r > 2 ? arguments[2] : void 0, u = void 0 === i ? n : Qt(i, n); u > o; )
            e[o++] = t;
        return e
    }
      , Se = Object.freeze({
      ...
      , Be = n(function(t, e) {
        ...
        function j(t, e, n) {
            ...
            for ((t = h(t)) != t || t === s ? (o = t != t ? 1 : 0,
            r = c) : (r = p(y(t) / _),
            1 > t * (i = d(2, -r)) && (r--,
            i *= 2),
            2 > (t += 1 > r + f ? l * d(2, 1 - f) : l / i) * i || (r++,
            i /= 2),
            c > r + f ? 1 > r + f ? (o = t * d(2, f - 1) * d(2, e),
            r = 0) : (o = (t * i - 1) * d(2, e),
            r += f) : (o = 0,
            r = c)); e >= 8; u[v++] = 255 & o,
            o /= 256,
        ...
        function L(t, e, n, r, o, u) {
            ...
            if (a + e > t[b])
                throw f(i);
            for (var c = t[m]._b, s = a + t[E], l = r(+o), h = 0; e > h; h++)
                c[s + h] = l[u ? h : e - h - 1]
        }
        if (Ie.ABV) {
            if (!v(function() {
                ...
                )[o] = l[o], R = n(l), C = 0; R.length > C; )
                    (F = R[C++])in u || Y(u, F, l[F]);
                Fe || (I.constructor = u)
            }
            var W = new a(new u(2))
              , U = a[o].setInt8;
            ...
            !W.getInt8(0) && W.getInt8(1) || Re(a[o], {
    ...
    Xe(Xe.P + Xe.U + Xe.F * v(function() {
        ...
        slice: function(t, e) {
            if (void 0 !== on && void 0 === e)
                return on.call(M(this), t);
            for (var n = M(this).byteLength, r = Qt(t, n), o = Qt(void 0 === e ? n : e, n), i = new (Qe(this, en))(kt(o - r)), u = new nn(this), a = new nn(i), c = 0; o > r; )
    ...
    var an = ze("toStringTag")
      ...
      , En = O ? Object.defineProperties : function(t, e) {
        M(t);
        for (var n, r = bn(e), o = r.length, i = 0; o > i; )
            T.f(t, n = r[i++], e[n]);
        return t
    }
      , On = Object.freeze({
      ...
      , Nn = function() {
        ...
        t.close(),
        Nn = t.F; n--; )
            delete Nn.prototype[ge[n]];
        return Nn()
    }
      , Pn = Object.create || function(t, e) {
        var n;
        return null !== t ? (zn.prototype = M(t),
        n = new zn,
        zn.prototype = null,
        n[Mn] = t) : n = Nn(),
        void 0 === e ? n : Sn(n, e)
      ...
      , In = Object.getPrototypeOf || function(t) {
        return t = we(t),
        q(t, Ln) ? t[Ln] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ? Fn : null
    }
      , Rn = Object.freeze({
        default: In,
        __moduleExports: In
      ...
      , Wn = $.getIteratorMethod = function(t) {
        if (void 0 != t)
            return t[Cn] || t["@@iterator"] || dn[Tn(t)]
    }
      , Un = Object.freeze({
        default: Wn,
        __moduleExports: Wn
      ...
      , Gn = function(t) {
        var e;
        return Dn(t) && ("function" != typeof (e = t.constructor) || e !== Array && !Dn(e.prototype) || (e = void 0),
        f(e) && null === (e = e[Vn]) && (e = void 0)),
        void 0 === e ? Array : e
    }
      , Jn = Object.freeze({
        default: Gn,
    ...
    var ar = function(t, e, n) {
      ...
      , vr = function(t, e, n, r, o, i, u) {
        ...
        }, l = e + " Iterator", h = "values" == o, d = !1, v = t.prototype, p = v[lr] || v["@@iterator"] || o && v[o], y = p || s(o), g = o ? h ? s("entries") : y : void 0, _ = "Array" == e && v.entries || p;
        if (_ && (f = sr(_.call(new t))) !== Object.prototype && f.next && (Ke(f, l, !0),
        Fe || "function" == typeof f[lr] || Y(f, lr, dr)),
        h && p && "values" !== p.name && (d = !0,
        y = function() {
            return p.call(this)
        }
        ),
        Fe && !u || !hr && !d && v[lr] || Y(v, lr, y),
        dn[e] = y,
        dn[l] = dr,
        o)
            if (a = {
      ...
      , mr = _r(Array, "Array", function(t, e) {
        ...
        var t = this._t
          , e = this._k
          , n = this._i++;
        return t && t.length > n ? gr(0, "keys" == e ? n : "values" == e ? t[n] : [n, t[n]]) : (this._t = void 0,
        gr(1))
    }, "values");
      ...
      , Ur = n(function(t) {
        if (O) {
            var e = Fe
              ...
              , Ut = function(t) {
                var e, n, r, o, i, a, c = j(t), f = arguments.length, s = f > 1 ? arguments[1] : void 0, l = void 0 !== s, h = M(c);
                if (void 0 != h && !w(h)) {
                    for (a = h.call(c),
                    r = [],
                    e = 0; !(i = a.next()).done; e++)
              ...
              , Vt = {
                ...
                reverse: function() {
                    for (var t, e = It(this).length, n = Math.floor(e / 2), r = 0; n > r; )
                        t = this[r],
                        this[r++] = this[--e],
                        this[e] = t;
                    return this
              ...
              , Xt = function(t, e, n) {
                return !(Yt(t, e = _(e, !0)) && E(n) && m(n, "value")) || m(n, "get") || m(n, "set") || n.configurable || m(n, "writable") && !n.writable || m(n, "enumerable") && !n.enumerable ? G(t, e, n) : (t[e] = n.value,
                t)
            };
            St || (V.f = qt,
            D.f = Xt),
            ...
            t.exports = function(t, u, c, f) {
                ...
                !y || !i.ABV ? (y = c(function(t, e, n, r) {
                    ...
                    var o, i, c, f, h = 0, v = 0;
                    if (E(e)) {
                        if (!(e instanceof tt || "ArrayBuffer" == (f = b(e)) || "SharedArrayBuffer" == f))
                            return At in e ? Ct(y, e) : Ut.call(y, e);
                        o = e,
                        v = Ft(n, u);
                        var g = e.byteLength;
                        if (void 0 === r) {
                ...
                s(O, "constructor", y)) : r(function() {
                    ...
                    var o;
                    return a(t, y, l),
                    E(e) ? e instanceof tt || "ArrayBuffer" == (o = b(e)) || "SharedArrayBuffer" == o ? void 0 !== r ? new g(e,Ft(n, u),r) : void 0 !== n ? new g(e,Ft(n, u)) : new g(e) : At in e ? Ct(y, e) : Ut.call(y, e) : new g(p(e))
                }),
                ...
                "BYTES_PER_ELEMENT"in O || s(O, "BYTES_PER_ELEMENT", u),
                o(o.P, l, Vt),
                U(l),
                o(o.P + o.F * Lt, l, {
                    set: Jt
    ...
    var Dr = function(t, e, n, r) {
          ...
          , r = t.exports = function(t, r, o, i, u) {
            ...
            if (Fr(l)) {
                for (a = kt(t.length); a > d; d++)
                    if ((s = r ? h(M(c = t[d])[0], c[1]) : h(t[d])) === e || s === n)
                        return s
            } else
                for (f = l.call(t); !(c = f.next()).done; )
                    if ((s = Gr(f, h, c.value, r)) === e || s === n)
                        return s
        }
        ;
        r.BREAK = e,
      ...
      , io = {
        getConstructor: function(t, e, n, r) {
            var o = t(function(t, i) {
                ...
                t._l = void 0,
                t[ro] = 0,
                void 0 != i && Qr(i, n, t[r], t)
            });
            return Re(o.prototype, {
                clear: function() {
                    for (var t = to(this, e), n = t._i, r = t._f; r; r = r.n)
                        r.r = !0,
        ...
        setStrong: function(t, e, n) {
            _r(t, e, function(t, n) {
                ...
                for (var t = this._k, e = this._l; e && e.r; )
                    e = e.p;
                return this._t && (this._l = e = e ? e.n : this._t._f) ? gr(0, "keys" == t ? e.k : "values" == t ? e.v : [e.k, e.v]) : (this._t = void 0,
                gr(1))
      ...
      , co = {
        set: Object.setPrototypeOf || ("__proto__"in {} ? function(t, e, n) {
            try {
                (n = ut(Function.call, Wr.f(Object.prototype, "__proto__").set, 2))(t, []),
      ...
      , ho = function(t, e, n) {
        ...
        return o !== n && "function" == typeof o && (r = o.prototype) !== n.prototype && f(r) && lo && lo(t, r),
        t
    }
      , vo = Object.freeze({
        default: ho,
    ...
    Object.getOwnPropertySymbols)
      ...
      , xo = !wo || v(function() {
        ...
        for (var n = we(t), r = arguments.length, o = 1, i = jo.f, u = zr.f; r > o; )
            for (var a, c = Dt(arguments[o++]), f = i ? bn(c).concat(i(c)) : bn(c), s = f.length, l = 0; s > l; )
    ...
    var Fo = {
        ...
        def: function(t, e, n) {
            var r = Ao(M(e), !0);
            return !0 === r ? Po(t).set(e, n) : r[t._i] = n,
            t
        },
        ufstore: Po
    }
      ...
      , To = Io && Fo || Io;
    n(function(t) {
        var e, n = Rr(0), r = Zr.getWeak, o = Object.isExtensible, i = To.ufstore, u = {}, a = function(t) {
            return function() {
                return t(this, arguments.length > 0 ? arguments[0] : void 0)
            }
        }, c = {
    ...
    var Uo = function(t, e, n) {
      ...
      , Go = Function.bind || function(t) {
        ...
        return f(e.prototype) && (r.prototype = e.prototype),
        r
    }
      , Jo = Object.freeze({
        default: Go,
    ...
    Xe(Xe.S, "Reflect", {
        set: function t(e, n, r) {
            var o, i, u = 4 > arguments.length ? e : arguments[3], a = Wr.f(M(e), n);
            if (!a) {
                if (f(i = sr(e)))
                    return t(i, n, r, u);
                a = C(0)
            ...
            return void 0 !== a.set && (a.set.call(u, r),
            !0)
        }
    }),
    so && Xe(Xe.S, "Reflect", {
    ...
    var oi, ii, ui, ai = g.process, ci = g.setImmediate, fi = g.clearImmediate, si = g.MessageChannel, li = g.Dispatch, hi = 0, di = {}, vi = function() {
        var t = +this;
    ...
    : si ? (ui = (ii = new si).port2,
    ii.port1.onmessage = pi,
    oi = ut(ui.postMessage, ui, 1)) : g.addEventListener && "function" == typeof postMessage && !g.importScripts ? (oi = function(t) {
        g.postMessage(t + "", "*")
    }
    ,
    ...
    var Si, Ai, Mi, zi, Ni = function(t) {
        ...
        default: Ri,
        __moduleExports: Ri
    }), Ci = Fi && Li || Fi, Wi = Ti && Ri || Ti, Ui = _i.set, Ki = (xi && wi || xi)(), Bi = g.TypeError, Di = g.process, Vi = g.Promise, Gi = "process" == Tn(Di), Ji = function() {}, Hi = Ai = Ii.f, Yi = !!function() {
        try {
            var t = Vi.resolve(1)
            ...
            Ki(function() {
                for (var r = t._v, o = 1 == t._s, i = 0, u = function(e) {
                    ...
                    try {
                        ...
                        s && (s.exit(),
                        u = !0)),
                        n === e.promise ? f(Bi("Promise-chain cycle")) : (i = qi(n)) ? i.call(n, c, f) : c(n)) : f(r)
                    } catch (t) {
                        s && !u && s.exit(),
                        f(t)
                    }
        ...
        if (!n._d) {
            ...
            try {
                if (n === t)
                    throw Bi("Promise can't be resolved itself");
                (e = qi(t)) ? Ki(function() {
                    var r = {
                        _w: n,
                        _d: !1
    ...
    Mi = function() {
        var t = new Si;
        this.promise = t,
        this.resolve = ut(eu, t, 1),
        this.reject = ut(tu, t, 1)
    }
    ,
    Ii.f = Hi = function(t) {
    ...
    var nu = {
      ...
      , cu = function(t) {
        var e = bn(t)
          , n = jo.f;
        if (n)
            for (var r, o = n(t), i = zr.f, u = 0; o.length > u; )
    ...
    : function(t) {
      ...
      , Wu = function(t, e, n) {
        return t === ku && Wu(Pu, e, n),
        M(t),
        e = N(e, !0),
        M(n),
        q(Nu, e) ? (n.enumerable ? (q(t, Su) && t[Su][e] && (t[Su][e] = !1),
        n = ir(n, {
            enumerable: C(0, !1)
        })) : (q(t, Su) || Eu(t, Su, C(1, {})),
        t[Su][e] = !0),
      ...
      , Uu = function(t, e) {
        M(t);
        for (var n, r = gu(e = $t(e)), o = 0, i = r.length; i > o; )
            Wu(t, n = r[o++], e[n]);
        return t
    }
      , Ku = function(t) {
      ...
      , Bu = function(t, e) {
        ...
        t !== ku || !q(Nu, e) || q(Pu, e)) {
            var n = bu(t, e);
            return !n || !q(Nu, e) || q(t, Su) && t[Su][e] || (n.enumerable = !0),
            n
        }
    }
      , Du = function(t) {
        for (var e, n = Ou($t(t)), r = [], o = 0; n.length > o; )
            q(Nu, e = n[o++]) || e == Su || e == mu || r.push(e);
        return r
    }
      , Vu = function(t) {
        for (var e, n = t === ku, r = Ou(n ? Pu : $t(t)), o = [], i = 0; r.length > i; )
            !q(Nu, e = r[i++]) || n && !q(ku, e) || o.push(Nu[e]);
        return o
    };
    Lu || (it((ju = function() {
        ...
        var t = X(arguments.length > 0 ? arguments[0] : void 0)
          , e = function(n) {
            this === ku && e.call(Pu, n),
            q(this, Su) && q(this[Su], t) && (this[Su][t] = !1),
            Ru(this, t, C(1, n))
        };
        return O && Iu && Ru(ku, t, {
            configurable: !0,
    ...
    zr.f = Ku,
    jo.f = Vu,
    O && !Fe && it(ku, "propertyIsEnumerable", Ku, !0),
    ou.f = function(t) {
        return Tu(ze(t))
    }
    ),
    ...
    for (var Gu = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), Ju = 0; Gu.length > Ju; )
        ze(Gu[Ju++]);
    for (var Hu = bn(ze.store), Yu = 0; Hu.length > Yu; )
        yu(Hu[Yu++]);
    ...
    ju.prototype[Au] || Y(ju.prototype, Au, ju.prototype.valueOf),
    Ke(ju, "Symbol"),
    Ke(Math, "Math", !0),
    Ke(g.JSON, "JSON", !0);
    var qu = function(t, e) {
    ...
    Xe(Xe.S, "String", {
        raw: function(t) {
            for (var e = $t(t.raw), n = kt(e.length), r = arguments.length, o = [], i = 0; n > i; )
                o.push(e[i++] + ""),
    ...
    var ca = function(t) {
        return function(e, n) {
            var r, o, i = Vt(e) + "", u = Mt(n), a = i.length;
    ...
    var za = function(t, e, n) {
        ...
        v(function() {
            ...
            ,
            7 != ""[t](e)
        }) && (it(String.prototype, t, i),
        Y(RegExp.prototype, r, 2 == e ? function(t, e) {
    ...
    Pa("split", 2, function(t, e, n) {
        ...
        if ("".split(/.?/).length) {
            ...
            n = function(t, e) {
                ...
                for (u || (a = RegExp("^" + y.source + "$(?!\\s)", d)); (c = y.exec(n)) && ((f = c.index + c[0].length) <= v || (h.push(n.slice(v, c.index)),
                !u && c.length > 1 && c[0].replace(a, function() {
                    for (l = 1; arguments.length - 2 > l; l++)
                        void 0 === arguments[l] && (c[l] = void 0)
                }),
                c.length > 1 && n.length > c.index && i.apply(h, c.slice(1)),
                s = c[0].length,
                v = f,
                p > h.length)); )
                    y.lastIndex === c.index && y.lastIndex++;
                return v === n.length ? !s && y.test("") || h.push("") : h.push(n.slice(v)),
    ...
    Xe(Xe.S + Xe.F * !Tr(function(t) {}), "Array", {
        from: function(t) {
            ...
            if (f && (c = ut(c, a > 2 ? arguments[2] : void 0, 2)),
            void 0 == l || u == Array && Fr(l))
                for (n = new u(e = kt(i.length)); e > s; s++)
                    Fa(n, s, f ? c(i[s], s) : i[s]);
            else
                for (o = l.call(i),
                n = new u; !(r = o.next()).done; s++)
                    Fa(n, s, f ? Gr(o, c, [r.value, s], !0) : r.value);
            return n.length = s,
            n
        }
    }),
    ...
    Xe(Xe.S, "Math", {
        hypot: function(t, e) {
            for (var n, r, o = 0, i = 0, u = arguments.length, a = 0; u > i; )
                (n = dc(arguments[i++])) > a ? (o = o * (r = a / n) * r + 1,
                a = n) : o += n > 0 ? (r = n / a) * r : n;
    ...
    var _c = zr.f
      , mc = function(t) {
        return function(e) {
            for (var n, r = $t(e), o = bn(r), i = o.length, u = 0, a = []; i > u; )
    ...
    Xe(Xe.S, "Object", {
        getOwnPropertyDescriptors: function(t) {
            for (var e, n, r = $t(t), o = Wr.f, i = ni(r), u = {}, a = 0; i.length > a; )
                void 0 !== (n = o(r, e = i[a++])) && Fa(u, e, n);
            return u
        }
    });
    ...
    for (var Lc = ze("iterator"), Fc = ze("toStringTag"), Ic = dn.Array, Rc = {
        ...
        var Wc, Uc = Tc[Cc], Kc = Rc[Uc], Bc = g[Uc], Dc = Bc && Bc.prototype;
        if (Dc && (Dc[Lc] || Y(Dc, Lc, Ic),
        Dc[Fc] || Y(Dc, Fc, Uc),
        dn[Uc] = Ic,
        Kc))
            for (Wc in mr)
                Dc[Wc] || it(Dc, Wc, mr[Wc], !0)
    }
    n(function(t) {
        !function(e) {
            var n, r = Object.prototype, o = r.hasOwnProperty, i = "function" == typeof Symbol ? Symbol : {}, u = i.iterator || "@@iterator", a = i.asyncIterator || "@@asyncIterator", c = i.toStringTag || "@@toStringTag", f = e.regeneratorRuntime;
            if (f)
                t.exports = f;
            else {
                ...
                O.prototype = _.constructor = j,
                j.constructor = O,
                j[c] = O.displayName = "GeneratorFunction",
    ...
    var Xc = {
      ...
      , ff = 12539
      , sf = [65377, 65381]
      , lf = [[12288, 12351], sf, [12539, 12540], [65281, 65295], [65306, 65311], [65339, 65343], [65371, 65376], [65504, 65518]]
      , hf = [].concat([[12352, 12447], [12448, 12543], sf, [65382, 65439]], lf, [[65313, 65338], [65345, 65370], [65296, 65305], [19968, 40959], [13312, 19903]])
      , df = [[0, 127]].concat([[256, 257], [274, 275], [298, 299], [332, 333], [362, 363]])
      , vf = [[32, 47], [58, 63], [91, 96], [123, 126]].concat([[8216, 8217], [8220, 8221]]);
    function pf() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
    ...
    function _f(t, e, n) {
        ...
        function o(t, e) {
            ...
            return function t(e, r, i, u) {
                if (!r)
                    return n || 1 === Object.keys(e).length ? e[""] ? [[i, u, e[""]]] : [] : [[i, u, null]];
                if (1 === Object.keys(e).length)
                    return [[i, u, e[""]]].concat(o(r, u));
                var a = function(t, e) {
                    if (void 0 !== t[e])
    ...
    function kf() {
        ...
        t.c = JSON.parse(JSON.stringify(t.k)),
        ...
        Object.entries(zf).forEach(function(t) {
            var n, r = Gc(t, 2), o = r[0], i = r[1], u = function(t) {
            ...
            e("l" + a(o))[u(o)] = c,
            (n = o,
            [].concat(Jc(Object.entries(Mf)), [["c", "k"]]).reduce(function(t, e) {
                var r = Gc(e, 2)
                  , o = r[0]
                  , i = r[1];
    ...
    function Bf() {
        ...
        e = t.useObsoleteKana ? Ff(e) : e,
        t.customKanaMapping && (null == Kf && (Kf = Of(e, t.customKanaMapping)),
        e = Kf),
        e
    }
    var Df = [];
    ...
    function Gf(t) {
        var e = t.type
          , n = t.target
          , r = t.data;
        /Mac/.test(window.navigator && window.navigator.platform) && ("compositionupdate" === e && yf(r) && (n.dataset.ignoreComposition = "true"),
        "compositionend" === e && (n.dataset.ignoreComposition = "false"))
    }
    function Jf() {
    ...
    function cs() {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {
          ...
          , n = !1;
        return t.passKanji || (n = e.some(as)),
        (e.some(os) || e.some(is)) && e.some(ts) && !n
    }
    var fs = function(t, e) {
        return Rf(t) && 1 > e
    }
    ...
    function xs() {
        ...
        Object.entries(js).forEach(function(t) {
            var e = Gc(t, 2);
            n(e[0], e[1])
        }),
        ...
        vs = Object.freeze(JSON.parse(JSON.stringify(t)))),
        vs
    }
    function Ss() {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : ""
        ...
        return function(t, e) {
            ...
            e.customRomajiMapping && (null == As && (As = Of(n, e.customRomajiMapping)),
            n = As);
    ...
    function Rs(t) {
        ...
        return u.reduce(function(t, e) {
            ...
            c = n;
            var u = e;
            return o && (u = (i ? t.pop().value : t.pop()) + u),
            t.concat(i ? {
                type: n,
                value: u
            } : u)
    ...
    t.bind = function() {
        ...
        t.addEventListener("compositionupdate", Gf),
        t.addEventListener("compositionend", Gf),
        function(t, e, n) {
            Df = Df.concat({
                id: t,
                inputHandler: e,
    ...
    ,
    t.unbind = function(t) {
        var e, n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], r = (e = t) && Df.find(function(t) {
